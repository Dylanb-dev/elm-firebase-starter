...
var $author$project$Cats$DataTest$suite = A2(
	$elm_explorations$test$Test$test,
	'decodes json from giphy api',
	function (_v0) {
		...
		return A2(
			...
			$elm$core$Result$Ok('foo.gif'),
			A2($elm$json$Json$Decode$decodeString, $author$project$Cats$Data$decodeGifUrl, fixture));
	});
var $author$project$Test$Generated$Main1480021906$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/dylanbroadbridge/Documents/dev/elm-firebase-starter/tests/Cats/DataTest.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$JsonReport,
		runs: $elm$core$Maybe$Nothing,
		seed: 233573078627585
	},
	$elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				'Cats.DataTest',
				_List_fromArray(
					[$author$project$Cats$DataTest$suite]))
			])));
_Platform_export({'Test':{'Generated':{'Main1480021906':{'init':$author$project$Test$Generated$Main1480021906$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-22677.sock";
